	...
	<section class="wishlist">
		<div class="container">
			<table class="table">
				...
				<tbody>
				  <tr>
					<th scope="row">${wl.getPriority()}</th>
					<td scope="row">${wl.getProductName()}</td>
					<td><form action="AddtoCartFromWishlistServlet" method="post">
						<input type="hidden" name="productName" value="${wl.getProductName()}"/>
						<button class="btn btn-primary" value="AddtoCartFromWishlistServlet">Add to Cart</button>
						</form></td>
					<td><form action="RemoveFromWishListServlet" method="post">
						<input type="hidden" name="productName" value="${wl.getProductName()}"/>
						<button class="btn btn-primary" value="RemoveFromWishListServlet">Remove</button>
						</form></td>	
				  </tr>
				</tbody>
				</c:forEach>
